    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='songs', to='songs.genre')),
            ],
        ),
        migrations.AddField(
            model_name='album',
        ...
        migrations.AddField(
            model_name='album',
            name='genre_id',
            field=models.ManyToManyField(related_name='albums', to='songs.genre'),
        ),
    ]
